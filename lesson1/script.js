...
/* 2. Работа с переменными. Объявить две переменные: admin и name. Записать в name строку
"Василий"; Скопировать значение из name в admin. Вывести admin (должно вывести «Василий»).*/
...
//      async - запускает скрипт без ожидания загрузки страницы 
//      defer - запускает код после прогрузки страницы